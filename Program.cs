...
{
    class Book //Defining a class Book
    {
        public int bookId;
    ...
    class BorrowDetails //Defining a class Borrow
    {
        public int userId;
    ...
    class Program
    {
        ...
        static void Main(string[] args)  //Give Verification with Your Password and Menu for which option you want to choose
        {
            
         Console.Write("!!!******** !!!Welcome To Library Of Lovely Professional University Punjab !!!*******!!!\nEnter your Secrate password :");
            
             string password = Console.ReadLine();
           
            //var userId = Console.ReadLine();
    
            if (password == "deepak@199")
            {
                bool close = true;
                while (close)
                {
            ...
            {
                Console.WriteLine("Please Enter Correct Password Here");
            }
            Console.ReadLine();
        }
        public static void GetBookissuing() //To add book details to the Library database
        {
            Book book = new Book();
        ...
        public static void RemoveBook() //To delete book details from the Library database 
        {
            Book book = new Book();
        ...
        public static void BorrowBookDetials()
        {
            Book book = new Book();
